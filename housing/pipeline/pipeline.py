...
class Pipeline(Thread):
    ...
    # experiment is named tuple of Experiment type.. see above code before class
    # we are initializing all the attributes of named tuple as none.
    experiment_file_path = None
    # these are the class level attributes, not the part of any function
    #these attributes / variables will be same for all the objects
    ...
    def run_pipeline(self):
        try:
            if Pipeline.experiment.running_status:
                ...
                # return previous experiment tuple, restricting from runnning it again. thread to be run once
            # data ingestion
            logging.info("Pipeline starting.")

            experiment_id = str(uuid.uuid4())
            # universal unique id generated using uuid
